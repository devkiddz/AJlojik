  ...
  return (
    <article className="group flex flex-col gap-2 mt-5 w-full">
      ...
      <div className="grid grid-cols-5 justify-between items-center px-2 w-full md:min-h-75 group overflow-hidden rounded-md transition-all bg-card/50 hover:bg-card">
        ...
        <div className="col-span-2 relative aspect-10/10 md:aspect-16/16">
        ...
        <div className="p-4 items-center justify-center col-span-3">
          <h3 className="line-clamp-1 text-xs md:text-2xl font-semibold pr-2">{product.name}</h3>
          <p className="mt-1 md:mt-2 line-clamp-2 text-[10px] md:text-sm text-muted-foreground">
            {product.shortDescription}
          </p>

          {/* category + PREVIEW */}
          <div className="mt-1 md:mt-3 flex items-cent gap-4">
            <span className="flex items-center gap-1 text-[10px] md:text-sm text-primary">
              <ChartColumnStacked className="h-2 w-2 md:h-5 md:w-5 text-rose-500" />
              {product.category}
            </span>
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-full border px-3 py-1 text-[10px] md:text-sm transition hover:bg-muted cursor-pointer">
              Preview
          ...
          {/* SIZE + PRICE */}
          <div className="mt-1 md:mt-4 flex items-end justify-between gap-4">
            ...
            <div className="flex flex-col items-start gap-2 w-full" onClick={e => e.stopPropagation()}>
              ...
              <div className="flex justify-between items-center w-full gap-2 md:gap-4 mt-2">
                <Select
                  ...
                  <SelectTrigger
                    className="text-[10px] md:text-sm h-3 md:h-8 w-[100px]"
