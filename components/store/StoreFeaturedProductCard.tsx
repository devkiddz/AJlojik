...
export default function ProductCard({ product, onSelect, onPreview, onToggleLike }: Props) {
  ...
  return (
    <article className="group flex flex-col gap-2 mt-5 max-w-2xl ">
      <div className="flex items-center gap-2">
        <Form className="w-5 h-5" />
        <h1 className="text-2xl">Picked for you</h1>
      </div>
      <div className="grid grid-cols-5 justify-between items-center px-2 w-full min-h-75 group overflow-hidden rounded-md transition-all bg-card/50 hover:bg-card">
        {/* FEATURED PRODUCT IMAGE */}

        <div className="col-span-2 relative aspect-16/16">
        ...
        <div className="p-4 items-center justify-center col-span-3">
          <h3 className="line-clamp-1 text-2xl font-semibold">{product.name}</h3>
