          ...
          return (
            <Button
              ...
              className={cn(
                ...
                active
                  ? 'border border-border/60 bg-brand-navy-light font-extrabold text-primary hover:bg-background hover:text-primary-foreground scale-[1.02]'
                  : ' bg-background text-muted-foreground hover:border-primary/30 hover:bg-muted/50 hover:text-foreground'
              )}>
              {category.label}
            </Button>
          );
