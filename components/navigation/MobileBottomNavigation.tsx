...
export default function MobileBottomNavigation({ onOpenDiscovery }: MobileBottomNavigationProps) {
  ...
  return (
    <nav
      ...
      className="fixed w-full inset-x-3 bottom-0 z-[60] pb-4 pt-2 lg:hidden bg-background/30 dark:bg-black/[0.15] backdrop-blur-xl border border-white/[0.08] dark:border-white/[0.04] shadow-[0_8px_32px_0_rgba(0,0,0,0.12)] saturate-[180%] backdrop-saturate-[180%]">
