    ...
    <div
      ...
      className={
        mobile
          ...
          : 'absolute left-1/2 -translate-x-1/2 top-full mt-3 w-[min(1180px,96vw)] overflow-hidden rounded-3xl border bg-background/95 backdrop-blur-xl shadow-2xl z-[999]'
      }>
      {loading ? (
        <SearchLoading />
      ) : (
