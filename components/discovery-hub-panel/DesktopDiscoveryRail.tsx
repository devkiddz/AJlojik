          ...
          {collapsed ? (
            ...
            <div className="relative h-full w-full overflow-hidden">
              <button
                ...
                className="absolute right-3 top-3 z-50 grid size-9 place-items-center rounded-full border border-border bg-background/85 text-muted-foreground shadow-sm backdrop-blur transition hover:text-foreground">
