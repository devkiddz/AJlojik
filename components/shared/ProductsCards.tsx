    ...
    <>
      {products.map((item, i) => (
        <motion.div
          ...
          <Link href={`/products/${item.id}`} aria-label="">
            ...
            <div>
              <h3 className="font-semibold rounded-full inset pt-2 text-sm md:text-md line-clamp-1">
                {item.name}
              </h3>
              <span className="text-primary flex items-center gap-1 pb-2 text-xs border-b border-b-muted mb-5">
